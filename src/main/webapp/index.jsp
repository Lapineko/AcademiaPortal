...
<%@ page import="com.academiaportal.dao.NewsDAO" %>
<%@ page import="com.academiaportal.dao.CarouselDAO" %>
<%@ page import="com.academiaportal.entity.News" %>
<%@ page import="com.academiaportal.entity.Carousel" %>
