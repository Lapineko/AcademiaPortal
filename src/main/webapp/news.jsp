...
<%@ page import="com.academiaportal.dao.NewsDAO,com.academiaportal.entity.News" %>
<%@ page import="java.sql.Timestamp" %>
<%@ page import="com.academiaportal.dao.NewsAttachmentDAO" %>
<%@ page import="com.academiaportal.entity.NewsAttachment" %>
